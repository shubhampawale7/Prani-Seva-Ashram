...
const About = () => {
  ...
  return (
    <section className="text-gray-800 bg-amber-50 min-h-screen py-16 px-4 md:px-10 lg:px-20">
      <div className="max-w-7xl mx-auto grid gap-16">
        <div
          ref={aboutRef}
          className="border-l-8 border-amber-400 bg-white shadow-xl p-10 rounded-3xl"
        >
        ...
        <div
          ref={missionRef}
          className="border-l-8 border-rose-400 bg-white shadow-xl p-10 rounded-3xl"
        >
        ...
        <div
          ref={visionRef}
          className="border-l-8 border-teal-400 bg-white shadow-xl p-10 rounded-3xl"
        >
